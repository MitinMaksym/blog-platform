...
describe('profileSlice', () => {
    ...
    test('setEditMode', () => {
        ...
        expect(profileReducer(state as ProfileSchema, profileActions.setEditMode(true))).toEqual({ editMode: true });
    });

    test('setProfileForm', () => {
        const state: DeepPartial<ProfileSchema> = { form: data };
        expect(profileReducer(state as ProfileSchema, profileActions.setProfileForm({ username: 'Test123' }))).toEqual({
    ...
    test('cancelFormEdit', () => {
        ...
        expect(profileReducer(state as ProfileSchema, profileActions.cancelFormEdit())).toEqual(newState);
    });
